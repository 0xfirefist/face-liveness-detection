...
train_generator=train_datagen.flow_from_directory('../dataset/face-dataset/train',
                                                 target_size=(64,64),
                                                 color_mode='rgb',
                                                 batch_size=BS,
                                                 class_mode='binary',
...
validation_generator=train_datagen.flow_from_directory('../dataset/face-dataset/test',
                                                 target_size=(64,64),
                                                 color_mode='rgb',
                                                 batch_size=BS,
                                                 class_mode='binary',
